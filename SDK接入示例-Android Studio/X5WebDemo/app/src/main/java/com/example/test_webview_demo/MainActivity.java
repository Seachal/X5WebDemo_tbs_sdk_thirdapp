...
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity1;
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity2False;
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity2True;
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity3False;
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity3True;
import com.example.test_webview_demo.shouldOverrideUrlLoading.BrowserActivity4;
...
public class MainActivity extends Activity {
    ...
    private void new_init() {
        ...
        int[] iconResourse = {R.drawable.tbsweb, R.drawable.fullscreen,
                R.drawable.filechooser, R.drawable.tbsweb,
                R.drawable.tbsweb, R.drawable.tbsweb,
                R.drawable.tbsweb, R.drawable.tbsweb,
                R.drawable.tbsweb, R.drawable.tbsweb
        };
...
//                        [Android调用系统自带浏览器打开网页的实现方法 - 云+社区 - 腾讯云](https://cloud.tencent.com/developer/article/1726768)
                        case TBS_WEB_7: {
                            ...
                            Uri content_url = Uri.parse(mHomeUrl);
