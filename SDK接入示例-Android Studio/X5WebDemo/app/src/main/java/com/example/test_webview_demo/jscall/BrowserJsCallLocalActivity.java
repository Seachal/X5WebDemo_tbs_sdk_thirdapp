...
public class BrowserJsCallLocalActivity extends Activity {
	/**
...
//	主页链接
    private static final String mHomeUrl = "file:///android_asset/webpage/java_js_bridge.html";
	...
	private void init() {
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String arg0, String arg1, String arg2,
				...
				new AlertDialog.Builder(BrowserJsCallLocalActivity.this)
						...
						.setPositiveButton("yes",
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
											int which) {
										Toast.makeText(
												BrowserJsCallLocalActivity.this,
