...
/**
 * 注意！！！  此页面使用的是  系统自带的 webview
 *
 * 不设置  WebViewClient,
 *
 * 相比于 BrowserActivity1  ，此页面有响应，响应方式为，
 *
 * 对于网页上的超链接，会有弹窗，让用户选择  浏览器程序去加载网页。
 *
 *
 *
 */
public class BrowserActivity4 extends Activity {
	/**
...
//				new AlertDialog.Builder(BrowserActivity4.this)
...
//		webSetting.setPluginState(WebSettings.PluginState.ON_DEMAND);
	...
	private void initBtnListenser() {
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(BrowserActivity4.this, "not completed",
