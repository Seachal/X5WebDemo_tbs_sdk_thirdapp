...
/**
 * 设置  WebViewClient,  使用  loadUrl()返回 false
 *
 * 若设置WebViewClient且在方法中调用loadUrl的话则不会走retrun,所以返回true和false都是无效的，会重新加载url。
 *
 * 和 BrowserActivity2False 的效果一样，这种情况下就会使用我们自己的webview来打开url.
 */
public class BrowserActivity3False extends Activity {
	/**
...
//				return false;
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String arg0, String arg1, String arg2,
				...
				new AlertDialog.Builder(BrowserActivity3False.this)
	...
	private void initBtnListenser() {
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(BrowserActivity3False.this, "not completed",
