...
/**
 * 设置  WebViewClient,返回 false
 *
 * 对于 webview 中的超链接， 没有拦截
 *
 * 这种情况下就会使用我们自己的webview来打开url.
 */
public class BrowserActivity2False extends Activity {
	/**
...
//		private static final String mHomeUrl = https://home.firefoxchina.cn/
	...
	private void init() {
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String arg0, String arg1, String arg2,
				...
				new AlertDialog.Builder(BrowserActivity2False.this)
	...
	private void initBtnListenser() {
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(BrowserActivity2False.this, "not completed",
