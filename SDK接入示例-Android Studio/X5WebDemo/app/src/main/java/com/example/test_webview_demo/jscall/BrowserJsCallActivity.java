...
public class BrowserJsCallActivity extends Activity {
	/**
...
//    private static final String mHomeUrl = "https://mjz.xiaoxianai.cn/auth?appid=L8UL3u6qQBC0vnRx&mobile=13133155803&number=000000&school_appid=wPvSYIekgfp6mnY5&timestamp=1662706204&vip=1&sign=937DF3493DD61F361C5E76BAB50DD54C";
	private static final String mHomeUrl = "https://test-yx.xkw.com/m/share/inviter?os=ANDROID";
...
//		 修改透明度，其实就是置灰
	...
	private void init() {
		...
		mWebView.addJavascriptInterface(new H5Bridge(this,mWebView),"Android");
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String arg0, String arg1, String arg2,
				...
				new AlertDialog.Builder(BrowserJsCallActivity.this)
	...
	private void initBtnListenser() {
		...
		mMore.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
			/*	Toast.makeText(BrowserJsCallActivity.this, "not completed",
...
//	初始化UI
	...
	private void aaabbb() {
		mWebView.loadUrl("javascript:aaa.bbb()");
	}

	// 测试 给 js  function 传参， 传进去了吗？
	private void test() {
		...
		mWebView.loadUrl("javascript:test('"+s1+"')");



	}

	private void getYxToken() {
		/*String s1 =  "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJ4a3ctbWFuYWdlci11c2VyIiwiaXNzIjoieGt3LXl4IiwiY29tcGFueSI6Ind3dy56eHhrLmNvbSIsInRpbWUiOjE2Nzg3ODMwMDkyMTUsImV4cCI6MTY3ODg2OTQwOSwidXNlcklkIjoiMzE3NDI4NTU4In0.YQNQQ3dsksFwtMmKCR51fce5C-FzTo0fetkHqN7Z-Hw";
		// 注意， 单括号'。
